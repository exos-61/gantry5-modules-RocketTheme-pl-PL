...
class plgEditorRokPad extends JPlugin
{
	...
	public function onDisplay($name, $content, $width, $height, $col, $row, $buttons = true, $id = null, $asset = null, $author = null, $params = array())
	{
		...
		$html[] = '			<li><div class="rok-button rok-button-primary rokpad-tip" data-original-title="Zapisywanie poprzez Ajax" data-placement="below-left" data-rokpad-save><i class="rokpad-icon-save"></i> zapisz</div></li>';
		$html[] = '			<li class="rok-buttons-group">';
		$html[] = '				<div class="rok-button rok-button-disabled rokpad-tip" data-original-title="Cofnij" data-placement="below" data-rokpad-undo><i class="rokpad-icon-undo"></i></div>';
		$html[] = '				<div class="rok-button rok-button-disabled rokpad-tip" data-original-title="Ponów" data-placement="below" data-rokpad-redo><i class="rokpad-icon-redo"></i></div>';
		$html[] = '			</li>';
		$html[] = '			<li><div class="rok-button rokpad-tip" data-original-title="Szukaj..." data-placement="below" data-rokpad-find><i class="rokpad-icon-search"></i></div></li>';
		$html[] = '			<li>';
		...
		$html[] = '						<li><a href="#" data-rokpad-goto>Idź do lini...</a></li>';
		$html[] = '						<li><a href="#" data-rokpad-find-replace>Szukaj i zamień...</a></li>';
		$html[] = '						<li class="divider"></li>';
		$html[] = '						<li><a href="#" data-rokpad-beautify>Uporządkuj kod HTML</a></li>';
		$html[] = '					</ul>';
		$html[] = '				</div>';
		$html[] = '			</li>';
		$html[] = '		</ul>';
		...
		$html[] = '					<div class="rok-button rokpad-tip" data-original-title="Ustawienia edytora" data-placement="below" data-rokpad-toggle="settings"><i class="rokpad-icon-settings"></i></div>';
		$html[] = '					<div class="rok-popover" data-rokpad-popover="settings">';
		$html[] = '						<ul class="options">';
		$html[] = '							<li><span class="title">Szablon</span><span class="input"><select data-rokpad-options="theme" class="chzn-done"></select></span></li>';
		$html[] = '							<li><span class="title">Wielkość czcionki</span><span class="input"><select data-rokpad-options="font-size" class="chzn-done"></select></span></li>';
		$html[] = '							<li><span class="title">Zwijanie kodu</span><span class="input"><select data-rokpad-options="fold-style" class="chzn-done"><option value="manual">Manual</option><option value="markbegin">Mark Begin</option><option value="markbeginend">Mark Begin and End</option></select></span></li>';
		$html[] = '							<li><span class="title">Zawijanie wierszy</span><span class="input"><select data-rokpad-options="use-wrap-mode" class="chzn-done"><option value="off">Off</option><option value="40">40 Chars</option><option value="80">80 Chars</option><option value="free">Free</option></select></span></li>';
		...
		$html[] = '							<li><span class="title-checkbox">Podświetlenie aktywnej linii</span><span class="input"><input type="checkbox" data-rokpad-options="highlight-active-line" /></span></li>';
		$html[] = '							<li><span class="title-checkbox">Pokaż ukryte znaki</span><span class="input"><input type="checkbox" data-rokpad-options="show-invisibles" /></span></li>';
		$html[] = '							<li><span class="title-checkbox">Pokaż rynnę</span><span class="input"><input type="checkbox" data-rokpad-options="show-gutter" /></span></li>';
		$html[] = '							<li><span class="title-checkbox">Pokaż Margines druku</span><span class="input"><input type="checkbox" data-rokpad-options="show-print-margin" /></span></li>';
		$html[] = '							<li><span class="title-checkbox">Podświetl wybrane słowo</span><span class="input"><input type="checkbox" data-rokpad-options="highlight-selected-word" /></span></li>';
		$html[] = '							<li><span class="title-checkbox">Autoukrywanie zwijania kodu</span><span class="input"><input type="checkbox" data-rokpad-options="fade-fold-widgets" /></span></li>';
		$html[] = '							<li><span class="title-checkbox">Autozapis co</span><span class="input"><input type="checkbox" data-rokpad-options="autosave-enabled" /> <input type="text" data-rokpad-options="autosave-time" /> minut</span></li>';
		$html[] = '						</ul>';
		...
		$html[] = '			<li>';
		$html[] = '				<div class="rok-popover-group">';
		$html[] = '					<div class="rok-button rokpad-tip" data-original-title="Skróty klawiaturowe" data-placement="below" data-rokpad-toggle="keyboard"><i class="rokpad-icon-keyboard"></i></div>';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Zmiana na duże litery</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Zmiana na małe litery</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		$html[] = '								<span class="rokpad-kbd-win"><span class="rokpad-key">SHIFT</span> + <span class="rokpad-key">ALT</span> + <span class="rokpad-key">&darr;</span></span>';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Kopiuj linię w dół</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		$html[] = '								<span class="rokpad-kbd-win"><span class="rokpad-key">SHIFT</span> + <span class="rokpad-key">ALT</span> + <span class="rokpad-key">&uarr;</span></span>';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Kopiuj linię na górę</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Zapisz</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Wyszukaj</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Wyszukaj zaznaczone</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Znajdź nastepny</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Znajdź poprzedni</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Zwiń wszystko</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Rozwiń wszystko</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Idź na dół.</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Idź do góry</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[]	= '								<span class="rokpad-kbd-mac"><span class="rokpad-key">&#8984</span> + <span class="rokpad-key">END</span> <br /><span class="rokpad-key">&#8984</span> + <span class="rokpad-key">&darr;</span></span><br />';
		$html[] = '								<span class="rokpad-kbd-desc">Przewijaj bez przemieszczania się kursora w dół <span class="rokpad-key">&darr;</span> lub na koniec <span class="rokpad-key">END</span></span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Idź w lewo</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Idź do lini nr</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Idź na koniec lini</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Idź na początek lini</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Przejdź stronę niżej</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Przejdź stronę wyżej</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Idź na prawo</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-mac"><span class="rokpad-key">&#8984;</span> + <span class="rokpad-key">HOME</span> <br /><span class="rokpad-key">&#8984;</span> + <span class="rokpad-key">&uarr;</span></span><br />';
		$html[] = '								<span class="rokpad-kbd-desc">Przewijaj bez przemieszczania się kursora w górę <span class="rokpad-key">&uarr;</span> lub na początek <span class="rokpad-key">HOME</span></span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Przeskocz lewy wyraz</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Przeskocz prawy wyraz</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Wcięcie w prawo</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Przesuń linie w dół</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Przesuń linie w górę</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Wcięcie w lewo</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Kursor nadpisywania</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		$html[] = '								<span class="rokpad-kbd-win"><span class="rokpad-key">PAGEDOWN</span></span>';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Ponów</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Usuń linię</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		$html[] = '								<span class="rokpad-kbd-win"><span class="rokpad-key">CTRL</span> + <span class="rokpad-key">K</span></span>';
		$html[] = '								<span class="rokpad-kbd-mac"><span class="rokpad-key">CTRL</span> + <span class="rokpad-key">K</span></span>';
		$html[] = '								<span class="rokpad-kbd-desc">Nie działa</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		$html[] = '								<span class="rokpad-kbd-win"><span class="rokpad-key">CTRL</span> + <span class="rokpad-key">BACKSPACE</span></span>';
		$html[] = '								<span class="rokpad-kbd-mac"><span class="rokpad-key">CTRL</span> + <span class="rokpad-key">BACKSPACE</span></span>';
		$html[] = '								<span class="rokpad-kbd-desc">Usuń lewy wyraz</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		$html[] = '								<span class="rokpad-kbd-win"><span class="rokpad-key">ALT</span> + <span class="rokpad-key">BACKSPACE</span> <br /> <span class="rokpad-key">CTRL</span> + <span class="rokpad-key">ALT</span> + <span class="rokpad-key">BACKSPACE</span></span>';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Usuń wyrazy na lewo</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		$html[] = '								<span class="rokpad-kbd-win"><span class="rokpad-key">CTRL</span> + <span class="rokpad-key">DELETE</span></span>';
		$html[] = '								<span class="rokpad-kbd-mac"><span class="rokpad-key">CTRL</span> + <span class="rokpad-key">DELETE</span></span>';
		$html[] = '								<span class="rokpad-kbd-desc">Usuń prawy wyraz</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		$html[] = '								<span class="rokpad-kbd-win"><span class="rokpad-key">ALT</span> + <span class="rokpad-key">DELETE</span></span>';
		$html[] = '								<span class="rokpad-kbd-mac"><span class="rokpad-key">ALT</span> + <span class="rokpad-key">DELETE</span></span>';
		$html[] = '								<span class="rokpad-kbd-desc">Usuń wyrazy na prawo</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Zaznacz wszystko</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		$html[] = '								<span class="rokpad-kbd-win"><span class="rokpad-key">SHIFT</span> + <span class="rokpad-key">&darr;</span></span>';
		$html[] = '								<span class="rokpad-kbd-mac"><span class="rokpad-key">SHIFT</span> + <span class="rokpad-key">&darr;</span></span><br />';
		$html[] = '								<span class="rokpad-kbd-desc">Zaznaczaj skokowo od kursora w dół</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		$html[] = '								<span class="rokpad-kbd-win"><span class="rokpad-key">SHIFT</span> + <span class="rokpad-key">&larr;</span></span>';
		$html[] = '								<span class="rokpad-kbd-mac"><span class="rokpad-key">SHIFT</span> + <span class="rokpad-key">&larr;</span></span><br />';
		$html[] = '								<span class="rokpad-kbd-desc">Zaznaczaj skokowo od kursora w lewo</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Zaznacz stronę w górę</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-mac"><span class="rokpad-key">SHIFT</span> + <span class="rokpad-key">&rarr;</span></span><br />';
		$html[] = '								<span class="rokpad-kbd-desc">Zaznaczaj skokowo od kursora w prawo</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-mac"><span class="rokpad-key">SHIFT</span> + <span class="rokpad-key">&uarr;</span></span><br />';
		$html[] = '								<span class="rokpad-kbd-desc">Zaznaczaj skokowo od kursora w górę</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Zaznacz/aj wyraz/zy z lewej</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Zaznacz/aj wyraz/zy z prawej</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac">';
		$html[] = '								<span class="rokpad-kbd-mac"><span class="rokpad-key">CTRL</span> + <span class="rokpad-key">O</span></span>';
		$html[] = '								<span class="rokpad-kbd-desc">Linia podziału</span>';
		$html[] = '							</li>';
		$html[] = '							<li class="rokpad-keyboard-mac rokpad-keyboard-win">';
		...
		$html[] = '								<span class="rokpad-kbd-desc">Cofnij</span>';
		$html[] = '							</li>';
		$html[] = '						</ul>';
		$html[] = '						<div class="rok-popover-arrow"></div>';
		$html[] = '					</div>';
